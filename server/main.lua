...
ESX.RegisterServerCallback('doj_casehub:getCaseDetails', responseSafe(DojCases.GetDetails))
...
ESX.RegisterServerCallback('doj_casehub:updateTaskStatus', responseSafe(DojCases.UpdateTaskStatus))
...
ESX.RegisterServerCallback('doj_casehub:listHearings', responseSafe(DojHearings.List))
ESX.RegisterServerCallback('doj_casehub:createHearing', responseSafe(DojHearings.Create))
ESX.RegisterServerCallback('doj_casehub:updateHearing', responseSafe(DojHearings.Update))
...
ESX.RegisterServerCallback('doj_casehub:listDocuments', responseSafe(DojDocuments.List))
